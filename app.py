...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Anh - Trường PTDTBT TH-THCS Hương Sơn</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2026 - Nguyễn Thị Anh - Trường PTDTBT TH-THCS Hương Sơn</div>", unsafe_allow_html=True)
